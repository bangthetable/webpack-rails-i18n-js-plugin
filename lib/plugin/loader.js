...
function readLocale(localeFile) {
  return yaml.safeLoad(fs.readFileSync(localeFile, 'utf8'))
}
...
module.exports = function(src) {
  ...
  var locales = !!options.localeFile ? readLocale(options.localeFile) : readLocales(options.localesPath)
